...
export const barrowsGlovesTemplate: TemplateDefinition = {
  ...
  nodes: [
    ...
    },
    {
      ...
      title: '70 Cooking',
      requirement: 'hard',
      rationale: 'Required for the King Awowogei subquest.',
    ...
    // ─── Hard: RFD Subquests ───
    {
      ...
      requirement: 'hard',
      rationale: 'Starting subquest — unlocks the rest of RFD.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'rfd_another_cooks_quest' },
    },
    {
      key: 'rfd-dwarf',
      type: 'quest',
      ...
      requirement: 'hard',
      rationale: 'One of 8 subquests required before Sir Amik Varze.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'rfd_mountain_dwarf' },
    },
    {
      key: 'rfd-goblins',
      type: 'quest',
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'rfd_goblin_generals' },
    },
    {
      key: 'rfd-pirate',
      type: 'quest',
      ...
      skillData: undefined,
      questData: { questId: 'rfd_pirate_pete' },
    },
    {
      key: 'rfd-dave',
      type: 'quest',
      ...
      skillData: undefined,
      questData: { questId: 'rfd_evil_dave' },
    },
    {
      key: 'rfd-skrach',
      type: 'quest',
      ...
      skillData: undefined,
      questData: { questId: 'rfd_skrach_uglogwee' },
    },
    {
      key: 'rfd-guide',
      type: 'quest',
      ...
      requirement: 'hard',
      rationale: 'The most prereq-heavy subquest — requires many completed quests.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'rfd_lumbridge_guide' },
    },
    {
      key: 'rfd-awowogei',
      type: 'quest',
      ...
      requirement: 'hard',
      rationale: 'Requires Monkey Madness I and 70 Cooking.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'rfd_king_awowogei' },
    },
    {
      key: 'rfd-amik',
      type: 'quest',
      ...
      requirement: 'hard',
      rationale: 'Final subquest — requires all other 8 subquests completed.',
      notes: 'Involves a challenging boss fight. Protection prayers recommended.',
      skillData: undefined,
      questData: { questId: 'rfd_sir_amik_varze' },
    },
    ...
    // ─── Soft: Direct Subquest Prerequisites ───
    {
      ...
      requirement: 'soft',
      rationale: "Prerequisite for Another Cook's Quest.",
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'cooks_assistant' },
    },
    {
      key: 'fishing-contest',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for the Mountain Dwarf subquest.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'fishing_contest' },
    },
    {
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for Goblin Generals and Lumbridge Guide subquests.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'goblin_diplomacy' },
    },
    {
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for the Evil Dave subquest.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'shadow_of_the_storm' },
    },
    {
      key: 'demon-slayer',
      type: 'quest',
      title: 'Demon Slayer',
      requirement: 'soft',
      rationale: 'Prerequisite for Shadow of the Storm and Lumbridge Guide.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'demon_slayer' },
    },
    {
      key: 'the-golem',
      type: 'quest',
      title: 'The Golem',
      requirement: 'soft',
      rationale: 'Prerequisite for Shadow of the Storm.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'the_golem' },
    },
    {
      key: 'gertudes-cat',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: 'Needed to obtain a kitten/cat for the Evil Dave subquest.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'gertudes_cat' },
    },
    {
      key: 'big-chompy',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for Skrach Uglogwee and Lumbridge Guide subquests.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'big_chompy_bird_hunting' },
    },
    {
      key: 'nature-spirit',
      type: 'quest',
      title: 'Nature Spirit',
      requirement: 'soft',
      rationale: 'Prerequisite for the Lumbridge Guide subquest.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'nature_spirit' },
    },
    {
      key: 'priest-in-peril',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for Nature Spirit. Unlocks Morytania.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'priest_in_peril' },
    },
    {
      key: 'lost-city',
      type: 'quest',
      title: 'Lost City',
      requirement: 'soft',
      rationale: "Prerequisite for Lumbridge Guide and Heroes' Quest.",
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'lost_city' },
    },
    {
      key: 'murder-mystery',
      type: 'quest',
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'murder_mystery' },
    },
    {
      key: 'witchs-house',
      type: 'quest',
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'witchs_house' },
    },
    {
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'ernest_the_chicken' },
    },
    {
      key: 'biohazard',
      type: 'quest',
      title: 'Biohazard',
      requirement: 'soft',
      rationale: 'Prerequisite for Lumbridge Guide and Underground Pass.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'biohazard' },
    },
    {
      key: 'plague-city',
      type: 'quest',
      title: 'Plague City',
      requirement: 'soft',
      rationale: 'Prerequisite for Biohazard.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'plague_city' },
    },
    {
      key: 'firemaking-20',
      type: 'skill',
      title: '20 Firemaking',
      requirement: 'soft',
      rationale: 'Required for the Skrach Uglogwee subquest.',
      notes: undefined,
      skillData: { skillName: 'Firemaking', targetLevel: 20, boost: undefined },
      questData: undefined,
    },
    ...
    // ─── Soft: Monkey Madness I Chain ───
    {
      ...
      skillData: undefined,
      questData: { questId: 'monkey_madness_i' },
    },
    {
      key: 'grand-tree',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: 'Prerequisite for Monkey Madness I.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'the_grand_tree' },
    },
    {
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'tree_gnome_village' },
    },
    ...
    // ─── Soft: Legend's Quest Chain ───
    {
      ...
      requirement: 'soft',
      rationale: 'Major QP contributor with a deep prereq chain that covers many skills you need.',
      notes: 'Requires 107 Quest Points to start.',
      skillData: undefined,
      questData: { questId: 'legends_quest' },
    },
    {
      key: 'heroes-quest',
      type: 'quest',
      title: "Heroes' Quest",
      requirement: 'soft',
      rationale: "Prerequisite for Legend's Quest. Requires 55 QP.",
      notes: 'Partner quest — need a friend or alt in the opposite gang.',
      skillData: undefined,
      questData: { questId: 'heroes_quest' },
    },
    {
      key: 'dragon-slayer',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: "Prerequisite for Heroes' Quest.",
      notes: '32 Quest Points required to start.',
      skillData: undefined,
      questData: { questId: 'dragon_slayer_i' },
    },
    {
      key: 'shield-of-arrav',
      type: 'quest',
      ...
      notes: 'Partner quest — need a friend or alt in the opposite gang.',
      skillData: undefined,
      questData: { questId: 'shield_of_arrav' },
    },
    {
      key: 'merlins-crystal',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: "Prerequisite for Heroes' Quest and Legend's Quest.",
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'merlins_crystal' },
    },
    {
      ...
      requirement: 'soft',
      rationale: "Prerequisite for Legend's Quest. Notoriously long.",
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'underground_pass' },
    },
    {
      key: 'waterfall-quest',
      type: 'quest',
      ...
      requirement: 'soft',
      rationale: "Prerequisite for Legend's Quest. Great early XP.",
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'waterfall_quest' },
    },
    {
      key: 'family-crest',
      type: 'quest',
      title: 'Family Crest',
      requirement: 'soft',
      rationale: "Prerequisite for Legend's Quest.",
      notes: 'Requires 40 Crafting, 40 Mining, 40 Smithing, 59 Magic.',
      skillData: undefined,
      questData: { questId: 'family_crest' },
    },
    {
      key: 'shilo-village',
      type: 'quest',
      ...
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'shilo_village' },
    },
    {
      key: 'jungle-potion',
      type: 'quest',
      title: 'Jungle Potion',
      requirement: 'soft',
      rationale: 'Prerequisite for Shilo Village.',
      notes: undefined,
      skillData: undefined,
      questData: { questId: 'jungle_potion' },
    },
    ...
    // ─── Soft: Legend's Quest Skills ───
    {
      ...
      title: '50 Agility',
      requirement: 'soft',
      rationale: "Required for Legend's Quest. Also covers 48 Agility for Monkey Madness I.",
      notes: undefined,
    ...
    },
    {
      ...
      title: '50 Crafting',
      requirement: 'soft',
      rationale: "Required for Legend's Quest. Also covers 42 Crafting for Pirate Pete.",
      notes: undefined,
    ...
    },
    {
      ...
      title: '56 Magic',
      requirement: 'soft',
      rationale: "Required for Legend's Quest.",
      notes: undefined,
      skillData: { skillName: 'Magic', targetLevel: 56, boost: undefined },
      questData: undefined,
    },
    {
      key: 'prayer-43',
      ...
      requirement: 'soft',
      rationale:
        "Legend's Quest needs 42. 43 unlocks protection prayers — essential for boss fights.",
      notes: undefined,
    ...
    },
    {
      ...
      rationale: "Required for Legend's Quest.",
      notes: undefined,
      skillData: { skillName: 'Smithing', targetLevel: 50, boost: undefined },
      questData: undefined,
    },
    {
      key: 'strength-50',
    ...
    // ─── Soft: Heroes' Quest Skills ───
    {
      ...
      title: '53 Fishing',
      requirement: 'soft',
      rationale: "Required for Heroes' Quest.",
      notes: undefined,
      skillData: { skillName: 'Fishing', targetLevel: 53, boost: undefined },
      questData: undefined,
    },
    {
      key: 'mining-53',
      ...
      title: '53 Mining',
      requirement: 'soft',
      rationale: "Required for Heroes' Quest (53) and Legend's Quest (52).",
      notes: undefined,
      skillData: { skillName: 'Mining', targetLevel: 53, boost: undefined },
      questData: undefined,
    },
    {
      key: 'herblore-25',
      ...
      rationale: "Required for Heroes' Quest.",
      notes: undefined,
      skillData: { skillName: 'Herblore', targetLevel: 25, boost: undefined },
      questData: undefined,
    },
    ...
    // ─── Soft: Underground Pass Skill ───
    {
      ...
      title: '25 Ranged',
      requirement: 'soft',
      rationale: 'Required for Underground Pass.',
      notes: undefined,
      skillData: { skillName: 'Ranged', targetLevel: 25, boost: undefined },
      questData: undefined,
    },
  ],
